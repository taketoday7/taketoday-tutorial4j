package cn.tuyucheng.taketoday.countupperandlowercasechars;
...
public class CountUpperAndLowercaseCharsUnitTest {
   private static final String MY_STRING = "Hi, Welcome to Tuyucheng! Let's count letters!";
   ...
   void whenUsingCountByCharacterRange_thenGetExpectedResult() {
      ...
      assertEquals(33, result.getLowercaseCount());
   }
