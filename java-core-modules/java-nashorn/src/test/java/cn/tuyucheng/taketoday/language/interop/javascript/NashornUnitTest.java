package cn.tuyucheng.taketoday.language.interop.javascript;
...
public class NashornUnitTest {
   ...
   public void bindingsExamples() throws ScriptException {
      ...
      bindings.put("name", "tuyucheng");

      String script = "var greeting='Hello ';" + "for(var i=count;i>0;i--) { " + "greeting+=name + ' '" + "}" + "greeting";

      Object bindingsResult = engine.eval(script, bindings);
      Assert.assertEquals("Hello tuyucheng tuyucheng tuyucheng ", bindingsResult);
   }
   ...
   public void jvmBoundaryExamples() throws ScriptException, NoSuchMethodException {
      ...
      Object funcResult = invocable.invokeFunction("composeGreeting", "tuyucheng");
      Assert.assertEquals("Hello tuyucheng", funcResult);
