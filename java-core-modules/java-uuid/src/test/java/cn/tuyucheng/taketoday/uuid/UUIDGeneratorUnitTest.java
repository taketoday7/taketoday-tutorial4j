...
class UUIDGeneratorUnitTest {
   ...
   @Test
   void version_3_UUID_is_correctly_generated_for_domain_tuyucheng_com() {

      UUID uuid = UUIDGenerator.generateType3UUID(NAMESPACE_DNS, "tuyucheng.com");
   ...
   @Test
   public void version_5_UUID_is_correctly_generated_for_domain_tuyucheng_com() throws UnsupportedEncodingException {

      UUID uuid = UUIDGenerator.generateType5UUID(NAMESPACE_URL, "tuyucheng.com");
   ...
   @Test
   public void version_5_UUID_is_correctly_generated_for_domain_tuyucheng_name() {

      UUID uuid = UUIDGenerator.generateType5UUID("tuyucheng.com");
