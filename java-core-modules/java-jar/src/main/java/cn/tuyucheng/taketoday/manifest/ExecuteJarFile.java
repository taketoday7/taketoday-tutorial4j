...
public class ExecuteJarFile {
   ...
   private static final String WORK_PATH = "src/main/java/com/tuyucheng/manifest";
   ...
   private static final String CREATE_JAR_WITHOUT_MF_ATT_COMMAND = "jar cvf example.jar com/tuyucheng/manifest/AppExample.class";
   private static final String CREATE_JAR_WITH_MF_ATT_COMMAND = "jar cvmf MANIFEST.MF example.jar com/tuyucheng/manifest/AppExample.class";
