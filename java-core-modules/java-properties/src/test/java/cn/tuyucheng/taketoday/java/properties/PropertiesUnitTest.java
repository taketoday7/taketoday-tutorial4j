package cn.tuyucheng.taketoday.java.properties;
...
public class PropertiesUnitTest {
   ...
   public void givenPropertyValue_whenPropertiesSet_thenCorrect() throws IOException {
      ...
      appProps.setProperty("downloadAddr", "www.tuyucheng.com/downloads");
      ...
      assertEquals("www.tuyucheng.com/downloads", newAppDownloadAddr);
   }
