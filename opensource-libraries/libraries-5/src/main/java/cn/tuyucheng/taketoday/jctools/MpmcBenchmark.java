...
public class MpmcBenchmark {
   ...
   public void setUp() {
      switch (implementation) {
         case PARAM_UNSAFE -> queue = new MpmcArrayQueue<>(CAPACITY);
         case PARAM_AFU -> queue = new MpmcAtomicArrayQueue<>(CAPACITY);
         case PARAM_JDK -> queue = new ArrayBlockingQueue<>(CAPACITY);
         default -> throw new UnsupportedOperationException("Unsupported implementation " + implementation);
      }
   }
