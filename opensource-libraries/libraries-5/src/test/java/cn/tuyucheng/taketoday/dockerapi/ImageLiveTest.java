...
public class ImageLiveTest {
   ...
   public void givenListOfImages_whenTagImage_thenListMustIncrement() {
      ...
      // when
      dockerClient.tagImageCmd(image.getId(), "tuyucheng/alpine", "3.6.v2").exec();
   ...
   public void pushingAnImage() throws InterruptedException {
      dockerClient.pushImageCmd("tuyucheng/alpine").withTag("3.6.v2").exec(new PushImageResultCallback()).awaitCompletion(90, TimeUnit.SECONDS);
   }
