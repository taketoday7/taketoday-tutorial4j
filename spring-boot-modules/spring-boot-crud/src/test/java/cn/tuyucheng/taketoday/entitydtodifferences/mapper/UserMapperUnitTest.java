...
class UserMapperUnitTest {
   ...
   @Test
   void givenUserEntity_whenMappedToDto_thenMappedCorrectly() {
      // given
   ...
   @Test
   void givenUserDto_whenMappedToEntity_thenMappedCorrectly() {
      // given
   ...
   @Test
   void givenBookEntity_whenMappedToDto_thenMappedCorrectly() {
      // given
   ...
   @Test
   void givenBookDto_whenMappedToEntity_thenMappedCorrectly() {
      // given
