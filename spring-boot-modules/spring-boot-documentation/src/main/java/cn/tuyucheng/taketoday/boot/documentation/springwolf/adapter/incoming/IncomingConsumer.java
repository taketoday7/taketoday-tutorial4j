package cn.tuyucheng.taketoday.boot.documentation.springwolf.adapter.incoming;

import cn.tuyucheng.taketoday.boot.documentation.springwolf.dto.IncomingPayloadDto;
import cn.tuyucheng.taketoday.boot.documentation.springwolf.service.ProcessorService;
...
public class IncomingConsumer {
   ...
   public void consume(IncomingPayloadDto payload) {
      LOGGER.info("Received new message: {}", payload.toString());
