...
class KthSmallestUnitTest {
   ...
   private void random() {
      ...
      int result = KthSmallest.findKthSmallestElement(k, list1, list2);

      int result2 = KthSmallest.getKthElementSorted(list1, list2, k);

      int result3 = KthSmallest.getKthElementMerge(list1, list2, k);
   ...
   class Exceptions {
      ...
      void when_at_least_one_list_is_null_then_an_exception_is_thrown() {
         ...
         Executable executable1 = () -> KthSmallest.findKthSmallestElement(1, null, null);
         Executable executable2 = () -> KthSmallest.findKthSmallestElement(1, new int[]{2}, null);
         Executable executable3 = () -> KthSmallest.findKthSmallestElement(1, null, new int[]{2});
      ...
      void when_at_least_one_list_is_empty_then_an_exception_is_thrown() {
         ...
         Executable executable1 = () -> KthSmallest.findKthSmallestElement(1, new int[]{}, new int[]{2});
         Executable executable2 = () -> KthSmallest.findKthSmallestElement(1, new int[]{2}, new int[]{});
         Executable executable3 = () -> KthSmallest.findKthSmallestElement(1, new int[]{}, new int[]{});
      ...
      void when_k_is_smaller_than_0_then_an_exception_is_thrown() {
         Executable executable1 = () -> KthSmallest.findKthSmallestElement(-1, new int[]{2}, new int[]{2});
         assertThrows(IllegalArgumentException.class, executable1);
      }

      @Test
      void when_k_is_smaller_than_1_then_an_exception_is_thrown() {
         Executable executable1 = () -> KthSmallest.findKthSmallestElement(0, new int[]{2}, new int[]{2});
         assertThrows(IllegalArgumentException.class, executable1);
      }

      @Test
      void when_k_bigger_then_the_two_lists_then_an_exception_is_thrown() {
         Executable executable1 = () -> KthSmallest.findKthSmallestElement(6, new int[]{1, 5, 6}, new int[]{2, 5});
...
//    }
   ...
   class K_is_smaller_than_the_size_of_list1_and_the_size_of_list2 {
      ...
      public void when_k_is_1_then_the_smallest_element_is_returned_from_list1() {
         int result = KthSmallest.findKthSmallestElement(1, new int[]{2, 7}, new int[]{3, 5});
         assertEquals(2, result);
      }

      @Test
      public void when_k_is_1_then_the_smallest_element_is_returned_list2() {
         int result = KthSmallest.findKthSmallestElement(1, new int[]{3, 5}, new int[]{2, 7});
         assertEquals(2, result);
      }
      ...
      public void when_kth_element_is_smallest_element_and_occurs_in_both_lists() {
         ...
         int result = KthSmallest.findKthSmallestElement(1, list1, list2);
      ...
      public void when_kth_element_is_smallest_element_and_occurs_in_both_lists2() {
         int[] list1 = new int[]{1, 2, 3};
         int[] list2 = new int[]{1, 2, 3};
         int result = KthSmallest.findKthSmallestElement(2, list1, list2);
         assertEquals(1, result);
      }
      ...
      public void when_kth_element_is_largest_element_and_occurs_in_both_lists_1() {
         int[] list1 = new int[]{1, 2, 3};
         int[] list2 = new int[]{1, 2, 3};
         int result = KthSmallest.findKthSmallestElement(5, list1, list2);
      ...
      public void when_kth_element_is_largest_element_and_occurs_in_both_lists_2() {
         int[] list1 = new int[]{1, 2, 3};
         int[] list2 = new int[]{1, 2, 3};
         int result = KthSmallest.findKthSmallestElement(6, list1, list2);
         assertEquals(3, result);
      }
      ...
      public void when_kth_element_and_occurs_in_both_lists() {
         ...
         int result = KthSmallest.findKthSmallestElement(3, list1, list2);
         assertEquals(2, result);
      }
      ...
      public void and_elements_in_first_list_are_all_smaller_than_second_list2() {
         int[] list1 = new int[]{1, 3, 7, 9};
         int[] list2 = new int[]{11, 12, 14, 15};
         int result = KthSmallest.findKthSmallestElement(4, list1, list2);
   ...
   class K_is_bigger_than_the_size_of_at_least_one_of_the_lists {
      ...
      public void when_k_is_bigger_than_the_size_of_both_lists() {
         ...
         int result = KthSmallest.findKthSmallestElement(7, list1, list2);
         assertEquals(9, result);
      }
      ...
      public void when_k_is_bigger_than_the_size_of_both_lists_and_list1_has_more_elements_than_list2() {
         ...
         int[] list2 = new int[]{1, 2, 3, 7, 13};
         int result = KthSmallest.findKthSmallestElement(11, list1, list2);
