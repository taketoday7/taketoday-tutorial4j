...
class FloggerIntegrationTest {
   ...
   @Test
   void givenASimpleOperation_shouldLogTheResult() {
      int result = 45 / 3;
      logger.atInfo().log("The result is %d", result);
   }

   @Test
   void givenCodeThatThrowsAndException_shouldLogTheException() {
      try {
         int result = 45 / 0;
   ...
   @Test
   void givenALoggingConfiguration_shouldLogAtTheConfiguredLevel() {
   ...
   @Test
   void givenALongRunningMethodForStats_shouldCallTheMethodLazily() {
