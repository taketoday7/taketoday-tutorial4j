 ...
 * generated in the com.tuyucheng.jaxws.client package.
...
public class ObjectFactory {
   ...
   private final static QName _AddEmployeeResponse_QNAME = new QName("http://bottomup.server.jaxws.tuyucheng.com/", "addEmployeeResponse");
   private final static QName _EmployeeAlreadyExists_QNAME = new QName("http://bottomup.server.jaxws.tuyucheng.com/", "EmployeeAlreadyExists");
   private final static QName _GetEmployeeResponse_QNAME = new QName("http://bottomup.server.jaxws.tuyucheng.com/", "getEmployeeResponse");
   private final static QName _EmployeeNotFound_QNAME = new QName("http://bottomup.server.jaxws.tuyucheng.com/", "EmployeeNotFound");
   private final static QName _CountEmployees_QNAME = new QName("http://bottomup.server.jaxws.tuyucheng.com/", "countEmployees");
   private final static QName _UpdateEmployee_QNAME = new QName("http://bottomup.server.jaxws.tuyucheng.com/", "updateEmployee");
   private final static QName _DeleteEmployeeResponse_QNAME = new QName("http://bottomup.server.jaxws.tuyucheng.com/", "deleteEmployeeResponse");
   private final static QName _GetAllEmployeesResponse_QNAME = new QName("http://bottomup.server.jaxws.tuyucheng.com/", "getAllEmployeesResponse");
   private final static QName _DeleteEmployee_QNAME = new QName("http://bottomup.server.jaxws.tuyucheng.com/", "deleteEmployee");
   private final static QName _UpdateEmployeeResponse_QNAME = new QName("http://bottomup.server.jaxws.tuyucheng.com/", "updateEmployeeResponse");
   private final static QName _AddEmployee_QNAME = new QName("http://bottomup.server.jaxws.tuyucheng.com/", "addEmployee");
   private final static QName _GetAllEmployees_QNAME = new QName("http://bottomup.server.jaxws.tuyucheng.com/", "getAllEmployees");
   private final static QName _CountEmployeesResponse_QNAME = new QName("http://bottomup.server.jaxws.tuyucheng.com/", "countEmployeesResponse");
   private final static QName _GetEmployee_QNAME = new QName("http://bottomup.server.jaxws.tuyucheng.com/", "getEmployee");

   /**
    * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.tuyucheng.jaxws.client
    */
    ...
    */
   @XmlElementDecl(namespace = "http://bottomup.server.jaxws.tuyucheng.com/", name = "addEmployeeResponse")
    ...
    */
   @XmlElementDecl(namespace = "http://bottomup.server.jaxws.tuyucheng.com/", name = "EmployeeAlreadyExists")
    ...
    */
   @XmlElementDecl(namespace = "http://bottomup.server.jaxws.tuyucheng.com/", name = "getEmployeeResponse")
    ...
    */
   @XmlElementDecl(namespace = "http://bottomup.server.jaxws.tuyucheng.com/", name = "EmployeeNotFound")
    ...
    */
   @XmlElementDecl(namespace = "http://bottomup.server.jaxws.tuyucheng.com/", name = "countEmployees")
    ...
    */
   @XmlElementDecl(namespace = "http://bottomup.server.jaxws.tuyucheng.com/", name = "updateEmployee")
    ...
    */
   @XmlElementDecl(namespace = "http://bottomup.server.jaxws.tuyucheng.com/", name = "deleteEmployeeResponse")
    ...
    */
   @XmlElementDecl(namespace = "http://bottomup.server.jaxws.tuyucheng.com/", name = "getAllEmployeesResponse")
    ...
    */
   @XmlElementDecl(namespace = "http://bottomup.server.jaxws.tuyucheng.com/", name = "deleteEmployee")
    ...
    */
   @XmlElementDecl(namespace = "http://bottomup.server.jaxws.tuyucheng.com/", name = "updateEmployeeResponse")
    ...
    */
   @XmlElementDecl(namespace = "http://bottomup.server.jaxws.tuyucheng.com/", name = "addEmployee")
    ...
    */
   @XmlElementDecl(namespace = "http://bottomup.server.jaxws.tuyucheng.com/", name = "getAllEmployees")
    ...
    */
   @XmlElementDecl(namespace = "http://bottomup.server.jaxws.tuyucheng.com/", name = "countEmployeesResponse")
    ...
    */
   @XmlElementDecl(namespace = "http://bottomup.server.jaxws.tuyucheng.com/", name = "getEmployee")
