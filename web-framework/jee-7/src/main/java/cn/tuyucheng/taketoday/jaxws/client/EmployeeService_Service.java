 ...
 */
@WebServiceClient(name = "EmployeeService", targetNamespace = "http://bottomup.server.jaxws.tuyucheng.com/", wsdlLocation = "http://localhost:8080/employeeservice?wsdl")
public class EmployeeService_Service
   ...
   private final static QName EMPLOYEESERVICE_QNAME = new QName("http://bottomup.server.jaxws.tuyucheng.com/", "EmployeeService");
   ...
   public EmployeeService getEmployeeServiceImplPort() {
      return super.getPort(new QName("http://bottomup.server.jaxws.tuyucheng.com/", "EmployeeServiceImplPort"), EmployeeService.class);
   }
   ...
   public EmployeeService getEmployeeServiceImplPort(WebServiceFeature... features) {
      return super.getPort(new QName("http://bottomup.server.jaxws.tuyucheng.com/", "EmployeeServiceImplPort"), EmployeeService.class, features);
   }
