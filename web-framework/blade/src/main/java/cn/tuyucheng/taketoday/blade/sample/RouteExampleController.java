...
import cn.tuyucheng.taketoday.blade.sample.configuration.TuyuchengException;
...
public class RouteExampleController {
   ...
   @Route(value = "/triggerTuyuchengException")
   public void triggerTuyuchengException() throws TuyuchengException {
      throw new TuyuchengException("Foobar Exception to threat differently");
   }
