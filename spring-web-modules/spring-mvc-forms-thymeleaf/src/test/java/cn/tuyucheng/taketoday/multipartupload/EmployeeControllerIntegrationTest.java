...
class EmployeeControllerIntegrationTest {
	...
	@Test
	void givenEmployeeJsonAndMultipartFile_whenPostWithRequestPart_thenReturnsOK() throws Exception {
	...
	@Test
	void givenRequestPartAndRequestParam_whenPost_thenReturns200OK() throws Exception {
