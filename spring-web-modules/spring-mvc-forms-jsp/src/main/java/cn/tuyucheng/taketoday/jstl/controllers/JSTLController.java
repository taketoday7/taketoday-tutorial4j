package cn.tuyucheng.taketoday.jstl.controllers;

import cn.tuyucheng.taketoday.jstl.dbaccess.SQLConnection;
...
public class JSTLController {
	...
	private void generateDummy(Connection connection) throws SQLException {
		...
		preparedStatement.setString(1, "patrick@tuyucheng.com");
		...
		preparedStatement.setString(1, "bfrank@tuyucheng.com");
