...
class RxJavaHooksManualTest {

	private boolean initHookCalled = false;
	private boolean hookCalled = false;

	@Test
	void givenIOScheduler_whenCalled_shouldExecuteTheHooks() {
	...
	@Test
	void givenNewThreadScheduler_whenCalled_shouldExecuteTheHook() {
	...
	@Test
	void givenSingleScheduler_whenCalled_shouldExecuteTheHooks() {
