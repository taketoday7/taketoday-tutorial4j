...
class RxJavaUnitTest {
	@Test
	void givenObservable_whenZip_shouldAssertBlockingInASameThread() {
		// given
	...
	@Test
	void givenObservable_whenZip_shouldAssertOnTestSubscriber() {
		// given
		List<String> letters = Arrays.asList("A", "B", "C", "D", "E");
	...
	@Test
	void givenTestObserver_whenExceptionWasThrowsOnObservable_observerShouldGetError() {
		// given
		List<String> letters = Arrays.asList("A", "B", "C", "D", "E");
		TestSubscriber<String> subscriber = new TestSubscriber<>();
	...
	@Test
	void givenObservableThatEmitsEventPerSecond_whenUseAdvanceByTime_shouldEmitEventPerSecond() {
		// given
		List<String> letters = Arrays.asList("A", "B", "C", "D", "E");
