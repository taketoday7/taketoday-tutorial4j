...
class RxAggregateOperatorsUnitTest {

	@Test
	void givenTwoObservable_whenConcatenatingThem_thenSuccessfull() {
		// given
	...
	@Test
	void givenObservable_whenCounting_thenObtainingNumberOfElements() {
		// given
	...
	@Test
	void givenObservable_whenReducing_thenObtainingInvertedConcatenatedString() {
		// given
	...
	@Test
	void givenObservable_whenCollecting_thenObtainingASet() {
		// given
	...
	@Test
	void givenObservable_whenUsingToList_thenObtainedAList() {
		// given
	...
	@Test
	void givenObservable_whenUsingToSortedList_thenObtainedASortedList() {
		// given
	...
	@Test
	void givenObservable_whenUsingToSortedListWithComparator_thenObtainedAnInverseSortedList() {
		// given
		Observable<Integer> sourceObservable = Observable.range(10, 5);
		TestSubscriber<List> subscriber = TestSubscriber.create();
	...
	@Test
	void givenObservable_whenUsingToMap_thenObtainedAMap() {
		// given
	...
	@Test
	void givenObservable_whenUsingToMultiMap_thenObtainedAMultiMap() {
		// given
		Observable<Book> bookObservable = Observable
			.just(
				new Book("The North Water", 2016),
	...
	class Book {
		...
		Book(String title, Integer year) {
			this.title = title;
			this.year = year;
		}
