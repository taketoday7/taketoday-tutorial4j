...
class RxJavaCustomOperatorUnitTest {

	@Test
	void whenUseCleanStringOperator_thenSuccess() {
	...
	@Test
	void whenUseToLengthOperator_thenSuccess() {
	...
	@Test
	void whenUseFunctionOperator_thenSuccess() {
	...
	@Test
	void whenUseFunctionTransformer_thenSuccess() {
