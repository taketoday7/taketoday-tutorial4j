...
class AsyncAndSyncToObservableIntegrationTest {
	...
	@Test
	void givenSyncMethod_whenConvertedWithFromCallable_thenReturnObservable() {
	...
	@Test
	void givenSyncMethod_whenConvertedWithStart_thenReturnObservable() {
	...
	/* Method will execute only once and cache its result.*/
	@Test
	void givenAsyncMethod_whenConvertedWithFromFuture_thenRetrunObservble() {
	...
	/* Method will execute every time it gets subscribed*/
	@Test
	void givenAsyncMethod_whenConvertedWithStartFuture_thenRetrunObservble() {
	...
	/*Method will execute only once and cache its result.*/
	@Test
	void givenAsyncMethod_whenConvertedWithDeferFuture_thenRetrunObservble() {
