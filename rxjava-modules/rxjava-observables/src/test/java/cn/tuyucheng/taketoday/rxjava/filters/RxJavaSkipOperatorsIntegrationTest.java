...
class RxJavaSkipOperatorsIntegrationTest {

	@Test
	void givenRangeObservable_whenSkipping_thenFirstFourItemsAreSkipped() {
	...
	@Test
	void givenObservable_whenSkippingWhile_thenFirstItemsAreSkipped() {
	...
	@Test
	void givenRangeObservable_whenSkippingLast_thenLastFiveItemsAreSkipped() {
		Observable<Integer> sourceObservable = Observable.range(1, 10);
		TestSubscriber<Integer> subscriber = new TestSubscriber();
	...
	@Test
	void givenObservable_whenFilteringDistinct_thenOnlyDistinctValuesAreEmitted() {
	...
	@Test
	void givenObservable_whenFilteringDistinctUntilChanged_thenOnlyDistinctConsecutiveItemsAreEmitted() {
		Observable<Integer> sourceObservable = Observable.just(1, 1, 2, 2, 1, 3, 3, 1);
		TestSubscriber<Integer> subscriber = new TestSubscriber();
	...
	@Test
	void givenRangeObservable_whenIgnoringElements_thenOnlyDistinctConsecutiveItemsAreEmitted() {
		Observable<Integer> sourceObservable = Observable.range(1, 10);
		TestSubscriber<Integer> subscriber = new TestSubscriber();
