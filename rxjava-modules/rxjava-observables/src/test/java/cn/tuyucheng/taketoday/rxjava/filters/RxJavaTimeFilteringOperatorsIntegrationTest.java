...
class RxJavaTimeFilteringOperatorsIntegrationTest {

	@Test
	void givenTimedObservable_whenSampling_thenOnlySampleItemsAreEmitted() {
	...
	@Test
	void givenTimedObservable_whenThrottlingLast_thenThrottleLastItemsAreEmitted() {
		TestScheduler testScheduler = new TestScheduler();
	...
	@Test
	void givenRangeObservable_whenThrottlingFirst_thenThrottledFirstItemsAreEmitted() {
		TestScheduler testScheduler = new TestScheduler();
	...
	@Test
	void givenTimedObservable_whenThrottlingWithTimeout_thenLastItemIsEmitted() {
		TestScheduler testScheduler = new TestScheduler();
	...
	@Test
	void givenTimedObservable_whenDebounceOperatorIsApplied_thenLastItemIsEmitted() {
		TestScheduler testScheduler = new TestScheduler();
	...
	@Test
	void givenTimedObservable_whenUsingTimeout_thenTimeOutException() {
		TestScheduler testScheduler = new TestScheduler();
	...
	@Test
	void givenObservable_whenSkippingUntil_thenItemsAreSkippedUntilSecondObservableEmitsItems() {
		TestScheduler testScheduler = new TestScheduler();
	...
	@Test
	void givenObservable_whenSkippingWhile_thenItemsAreEmittedUntilSecondObservableEmitsItems() {
		TestScheduler testScheduler = new TestScheduler();
