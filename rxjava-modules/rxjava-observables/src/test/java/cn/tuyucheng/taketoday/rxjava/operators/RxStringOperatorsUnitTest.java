...
class RxStringOperatorsUnitTest {

	@Test
	void givenStringObservable_whenFromInputStream_ThenSuccessfull() {
		// given
	...
	@Test
	void givenStringObservable_whenEncodingString_ThenSuccessfullObtainingByteStream() {
		// given
	...
	@Test
	void givenStringObservable_whenConcatenatingStrings_ThenSuccessfullObtainingSingleString() {
		// given
	...
	@Test
	void givenStringObservable_whenDecodingByteArray_ThenSuccessfullObtainingStringStream() {
		// given
	...
	@Test
	void givenStringObservable_whenStringSplitted_ThenSuccessfullObtainingStringsStream() {
		// given
		Observable<String> sourceObservable = Observable.just("Lorem ipsum loream,Lorem ipsum lore");
		TestSubscriber<String> subscriber = TestSubscriber.create();
	...
	@Test
	void givenStringObservable_whenSplittingByLine_ThenSuccessfullObtainingStringsStream() {
		// given
		Observable<String> sourceObservable = Observable.just("Lorem ipsum loream\nLorem ipsum lore");
		TestSubscriber<String> subscriber = TestSubscriber.create();
	...
	@Test
	void givenStringObservable_whenJoiningStrings_ThenSuccessfullObtainingSingleString() {
		// given
		Observable<String> sourceObservable = Observable.just("Lorem ipsum loream", "Lorem ipsum lore");
		TestSubscriber<String> subscriber = TestSubscriber.create();
