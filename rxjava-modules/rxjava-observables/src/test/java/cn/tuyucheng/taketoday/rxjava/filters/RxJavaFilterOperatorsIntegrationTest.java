...
class RxJavaFilterOperatorsIntegrationTest {
	...
	@Test
	void givenRangeObservable_whenFilteringItems_thenOddItemsAreFiltered() {
	...
	@Test
	void givenRangeObservable_whenFilteringWithTake_thenOnlyFirstThreeItemsAreEmitted() {
		Observable<Integer> sourceObservable = Observable.range(1, 10);
		TestSubscriber<Integer> subscriber = new TestSubscriber();
	...
	@Test
	void givenObservable_whenFilteringWithTakeWhile_thenItemsEmittedUntilConditionIsVerified() {
	...
	@Test
	void givenRangeObservable_whenFilteringWithTakeFirst_thenOnlyFirstItemIsEmitted() {
	...
	@Test
	void givenRangeObservable_whenFilteringWithFirst_thenOnlyFirstThreeItemsAreEmitted() {
		Observable<Integer> sourceObservable = Observable.range(1, 10);
		TestSubscriber<Integer> subscriber = new TestSubscriber();
	...
	@Test
	void givenEmptyObservable_whenFilteringWithFirstOrDefault_thenDefaultValue() {
	...
	@Test
	void givenRangeObservable_whenFilteringWithTakeLast_thenLastThreeItemAreEmitted() {
		Observable<Integer> sourceObservable = Observable.range(1, 10);
		TestSubscriber<Integer> subscriber = new TestSubscriber();
	...
	@Test
	void givenRangeObservable_whenFilteringWithLast_thenOnlyLastItemIsEmitted() {
		Observable<Integer> sourceObservable = Observable.range(1, 10);
		TestSubscriber<Integer> subscriber = new TestSubscriber();
	...
	@Test
	void givenRangeObservable_whenFilteringWithLastAndDefault_thenOnlyDefaultIsEmitted() {
		Observable<Integer> sourceObservable = Observable.range(1, 10);
		TestSubscriber<Integer> subscriber = new TestSubscriber();
	...
	@Test
	void givenObservable_whenTakingElementAt_thenItemAtSpecifiedIndexIsEmitted() {
	...
	@Test
	void givenObservable_whenTakingElementAtOrDefault_thenDefaultIsReturned() {
		Observable<Integer> sourceObservable = Observable.just(1, 2, 3, 5, 7, 11);
		TestSubscriber<Integer> subscriber = new TestSubscriber();
	...
	@Test
	void givenMixedTypeObservable_whenFilteringByType_thenOnlyNumbersAreEmitted() {
