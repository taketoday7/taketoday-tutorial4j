...
class RxRelayIntegrationTest {

	@Test
	void whenObserverSubscribedToPublishRelay_thenItReceivesEmittedEvents() {
	...
	@Test
	void whenObserverSubscribedToBehaviorRelayWithoutDefaultValue_thenItIsEmpty() {
	...
	@Test
	void whenObserverSubscribedToBehaviorRelay_thenItReceivesDefaultValue() {
	...
	@Test
	void whenObserverSubscribedToBehaviorRelay_thenItReceivesEmittedEvents() {
		BehaviorRelay<Integer> behaviorRelay = BehaviorRelay.create();
		TestObserver<Integer> firstObserver = TestObserver.create();
		TestObserver<Integer> secondObserver = TestObserver.create();
	...
	@Test
	void whenObserverSubscribedToReplayRelay_thenItReceivesEmittedEvents() {
	...
	@Test
	void whenObserverSubscribedToReplayRelayWithLimitedSize_thenItReceivesEmittedEvents() {
	...
	@Test
	void whenObserverSubscribedToReplayRelayWithMaxAge_thenItReceivesEmittedEvents() throws InterruptedException {
	...
	@Test
	void whenTwoObserversSubscribedToRandomRelay_thenOnlyOneReceivesEvent() {
