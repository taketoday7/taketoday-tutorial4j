...
class FlowableIntegrationTest {
	...
	@Test
	void whenFlowableIsCreated_thenItIsProperlyInitialized() {
		Flowable<Integer> integerFlowable = Flowable.just(1, 2, 3, 4);
		assertNotNull(integerFlowable);
	}

	@Test
	void whenFlowableIsCreatedFromObservable_thenItIsProperlyInitialized() throws InterruptedException {
	...
	@Test
	void whenFlowableIsCreatedFromFlowableOnSubscribe_thenItIsProperlyInitialized() throws InterruptedException {
