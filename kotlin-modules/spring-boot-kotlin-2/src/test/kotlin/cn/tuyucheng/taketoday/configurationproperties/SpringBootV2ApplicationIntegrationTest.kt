...
class SpringBootV2ApplicationIntegrationTest {
   ...
   @Autowired
   lateinit var apiConfiguration: cn.tuyucheng.taketoday.configurationproperties.config.ApiConfiguration

   @Autowired
   lateinit var personController: cn.tuyucheng.taketoday.autowired.PersonController

   @Autowired
   lateinit var inventoryController: cn.tuyucheng.taketoday.autowired.InventoryController
