...
class AbstractMapperUnitTest {
   ...
   private var userMapper: cn.tuyucheng.taketoday.mapstruct.mapper.custom.AbstractMapper = Mappers.getMapper(cn.tuyucheng.taketoday.mapstruct.mapper.custom.AbstractMapper::class.java)
