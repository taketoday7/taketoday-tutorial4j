...
fun main() {
   ...
   try {
      ...
      Files.createDirectory(Paths.get("./core-kotlin-modules/core-kotlin-5/src/main/kotlin/cn/tuyucheng/taketoday/createdirectory/createDirectory"))
   } catch (e: Exception) {
   ...
   try {
      ...
      Files.createDirectory(Paths.get("./core-kotlin-modules/core-kotlin-5/src/main/kotlin/cn/tuyucheng/taketoday/createdirectory/createDirectory_2/inner"))
   } catch (e: Exception) {
      println("Files.createDirectory throws an error, use `createDirectories` instead")
   }

   println("Running File(...).mkdir")
   val resultMkdir = File("./core-kotlin-modules/core-kotlin-5/src/main/kotlin/cn/tuyucheng/taketoday/createdirectory/mkdir").mkdir()
   println("Running File(...).mkdir result: $resultMkdir")

   println("Running File(...).mkdir 2nd time")
   val resultMkdirRerun = File("./core-kotlin-modules/core-kotlin-5/src/main/kotlin/cn/tuyucheng/taketoday/createdirectory/mkdir").mkdir()
   ...
   val resultMkdirNested = File("./core-kotlin-modules/core-kotlin-5/src/main/kotlin/cn/tuyucheng/taketoday/createdirectory/mkdir_2/inner").mkdir()
