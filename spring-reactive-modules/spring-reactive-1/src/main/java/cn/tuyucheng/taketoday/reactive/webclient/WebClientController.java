...
public class WebClientController {
   ...
   public String handleFormUpload(@RequestPart("key1") String value1, @RequestPart("key2") String value2) {
      return STR."processed-\{value1}\{'-'}\{value2}";
   }
}