...
public class AuthResolverIntegrationTest {
   ...
   public void givenCustomerCredential_whenWelcomeCustomer_thenExpectOk() {
      testClient
            ...
            .header("Authorization", STR."Basic \{Base64.getEncoder().encodeToString("customer1:pass1".getBytes())}")
            .exchange()
            .expectStatus()
            .isOk();
   }
   ...
   public void givenEmployeeCredential_whenWelcomeCustomer_thenExpect401Status() {
      testClient
            .get()
            .uri("/customer/welcome")
            .header("Authorization", STR."Basic \{Base64.getEncoder().encodeToString("employee1:pass1".getBytes())}")
            .exchange()
            .expectStatus()
            .isUnauthorized();
   }
