...
public class CustomRequestEntityValidator implements Validator {
   ...
   public void validate(Object target, Errors errors) {
      ...
      if (request.getCode() != null && request.getCode()
         ...
         errors.rejectValue("code", "field.min.length", new Object[]{Integer.valueOf(MINIMUM_CODE_LENGTH)}, STR."The code must be at least [\{MINIMUM_CODE_LENGTH}] characters in length.");
      }
   }
}