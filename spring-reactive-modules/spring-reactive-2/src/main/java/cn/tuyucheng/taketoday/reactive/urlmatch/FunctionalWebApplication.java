...
public class FunctionalWebApplication {
   ...
   private RouterFunction<ServerResponse> routingFunction() {
      ...
      RouterFunction<ServerResponse> restfulRouter = route(GET("/"), _ -> ok().body(Flux.fromIterable(actors), Actor.class)).andRoute(POST("/"), serverRequest -> serverRequest.bodyToMono(Actor.class)
            .doOnNext(actors::add)
            .then(ok().build()));
