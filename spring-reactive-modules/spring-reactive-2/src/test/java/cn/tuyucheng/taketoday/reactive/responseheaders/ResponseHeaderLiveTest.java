...
public class ResponseHeaderLiveTest {
   ...
   private static final String ANNOTATION_BASE_URL = STR."\{BASE_URL}/response-header";
   private static final String FUNCTIONAL_BASE_URL = STR."\{BASE_URL}/functional-response-header";
   ...
   public void whenUsingResponseEntityBuilderRequest_thenObtainResponseWithCorrectHeaders() {
      ...
      ResponseSpec response = client.get()
            .uri(STR."\{ANNOTATION_BASE_URL}/response-entity")
            .exchange();
   ...
   public void whenUsingServerHttpResponseRequest_thenObtainResponseWithCorrectHeaders() {
      ResponseSpec response = client.get()
            .uri(STR."\{ANNOTATION_BASE_URL}/server-http-response")
            .exchange();
   ...
   public void whenUsingFunctionalHandlerRequest_thenObtainResponseWithCorrectHeaders() {
      ResponseSpec response = client.get()
            .uri(STR."\{FUNCTIONAL_BASE_URL}/single-handler")
            .exchange();
