...
public class FunctionalEndpointValidationsLiveTest {
   ...
   private static final String COMPLEX_EP_URL = STR."\{BASE_URL}/complex-handler-functional-validation";
   private static final String DRY_EP_URL = STR."\{BASE_URL}/dry-functional-validation";
   private static final String ANNOTATIONS_EP_URL = STR."\{BASE_URL}/annotated-functional-validation";
