...
public class BackpressureUnitTest {
   ...
   public void whenRequestingChunks10_thenMessagesAreReceived() {
      ...
      request.subscribe(integer -> LOGGER.debug(String.valueOf(integer)), Throwable::printStackTrace, () -> LOGGER.debug("All 50 items have been successfully processed!!!"), subscription -> {
         for (int i = 0; i < 5; i++) {
